...
public class CarController : MonoBehaviour
{
    ...
    private void FixedUpdate()
    {
        ...
        if (Physics.Raycast(rayPoint.position, -this.transform.up, out rayHit, groundRayLenght, GroundLayer))
        {
            isGrounded = true;
            /*
                rotateTo değişkenine her ile arabamız arasındaki açıyı alıyor.
                slerp ile aracın rotasyonunu yavaşça ayarlıyoruz
                slerp ve rotateTo kullanmak yerine direkt transform.rotationu ilk satıra eşitleyebiliriz
                ancak hoş bir görüntü olmuyor.
             */
